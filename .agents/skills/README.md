...
- `manifest/` — living-spec generator for `CLAUDE.md` (vendored from `The-Interdependency/skill-lib@d0f6209`); CI runs `generate.py --check`. Refresh with `python .agents/skills/manifest/generate.py --write`.
