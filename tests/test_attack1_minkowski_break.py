# ratios: loc_comments=21:9 imports_exports=3:2 calls_definitions=9:2
...
pytestmark = pytest.mark.skipif(
    not mb.UCNS_AVAILABLE,
    reason=getattr(mb, "UCNS_IMPORT_ERROR", "recursive UCNS API unavailable"),
)
